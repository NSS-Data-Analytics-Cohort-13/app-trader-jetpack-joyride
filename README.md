...
that are made available through the Apple App Store and Android Play Store. App Trader is a broker that purchases
 the rights to apps from developers in order to market the apps and offer in-app purchase. 
...
c. App Trader will spend an average of $1000 per month to market an app regardless of the price of the app.
 If App Trader owns rights to the app in both stores, 
...
In other words, an app with a rating of 0 can be expected to be in use for 1 year, 
...
c. Submit a report based on your findings. All analysis work must be done using PostgreSQL, 
